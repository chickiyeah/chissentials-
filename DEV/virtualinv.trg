...
IF type == "WRITABLE_BOOK" || type == "WRITTEN_BOOK"
pages = meta.getPages().toString()
pages = pages.replace("[", "")
pages = pages.replace("]", "")
bookpagee = pages
IF type == "WRITTEN_BOOK"
booktitle = meta.getTitle()
...
q = 0
	FOR j = 0:size
		...
		ENDIF
	ENDFOR
msg = "i/type/amount/displayname/durability/booktitle/bookauthor/bookpages/lore/enchant"
stri = Integer.toString(i)
IF displayname != null && displayname != ""
msg = msg.replace("displayname", displayname)
ELSE
msg = msg.replace("displayname", "nulle")
ENDIF
IF type == "WRITABLE_BOOK" || type == "WRITTEN_BOOK"
msg = msg.replace("bookpages", bookpagee)
IF type == "WRITTEN_BOOK"
msg = msg.replace("booktitle", booktitle)
msg = msg.replace("bookauthor", bookauthor)
ELSE
msg = msg.replace("booktitle", "nulle")
msg = msg.replace("bookpages", "nulle")
msg = msg.replace("bookauthor", "nulle")
ENDIF
